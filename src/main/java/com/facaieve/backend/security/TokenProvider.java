...
public class TokenProvider {
    ...
    @Value("${custom.secret.key}")//보안상의 이유로 key 는 application.yml 저장함
    private String SECRET_KEY;

    public String create(JwtRequest jwtRequest) {
        // 기한 지금으로부터 1일로 설정
   ...
   */
        ...
        return Jwts.builder()
                ...
                // payload에 들어갈 내용
                .setSubject(jwtRequest.getEmail()) // sub 우리의 경우에 사용자의 이메일을 사용함.
                .claim("role",jwtRequest.getRole())//권한도 함께 넣음
    ...
    public UserRole extractRole(String token){//todo test 요망함
